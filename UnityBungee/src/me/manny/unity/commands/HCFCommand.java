...
public class HCFCommand extends Command {
	
	public HCFCommand() {
		super("hcf", "unity.commands.server", new String[] { "factions" });
	}
	...
	public void execute(CommandSender sender, String[] args) {
		...
		ServerInfo server = (ServerInfo)servers.get("HCF");
		if(server == null) {
			sender.sendMessage(ChatColor.RED + "The server 'HCF' is not found!");
			return;
		}
		int NIG = 1;
