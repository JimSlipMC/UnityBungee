...
public class KitsCommand extends Command {
	...
	public KitsCommand() {
		super("kits", "unity.commands.server", new String[] { "kitmap" });
	}
	...
	public void execute(CommandSender sender, String[] args) {
		...
		ServerInfo server = (ServerInfo)servers.get("Kits");
		if(server == null) {
			sender.sendMessage(ChatColor.RED + "The server 'Kits' is not found!");
			return;
		}
		int NIG = 1;
